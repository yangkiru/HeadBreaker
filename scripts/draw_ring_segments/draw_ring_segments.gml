function draw_ring_segments(x, y, radius, thickness, max_segments, segments, start_angle, total_angle, direction, colour) {
	...
	draw_triangle_colour(ax,ay,bx,by,dx,dy,argument9,argument9,argument9,thickness)
	draw_triangle_colour(ax,ay,cx,cy,dx,dy,argument9,argument9,argument9,thickness)
